...
// person images
import dashboard_logo from "../assets/images/layout.png";
...
export const iconsImgs = {
    alert, bell, bills, budget, card, check, empty_check, gears, home, menu, plane, plus, report, search, user, wallet, wealth,downarrow
}

export const personsImgs = {
    dashboard_logo, person_one, person_two, person_three, person_four
};
